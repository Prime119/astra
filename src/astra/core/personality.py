...
class Personality:
    ...
    def system_prompt_fragment(self) -> str:
        ...
        lines = [
            ...
            "- Solo saluda si es la PRIMERA interacción del día o después de mucho tiempo.",
            "- En medio de una conversación, ve DIRECTO al punto. Sin 'hola' ni '¿cómo estás?'.",
            "- Respuestas CORTAS y directas. No repitas lo que ya dijiste.",
            "",
            "FORMA DE HABLAR:",
            "- Natural, fluida, español mexicano coloquial.",
            "- Sarcástica cuando quieres, sin explicarlo.",
